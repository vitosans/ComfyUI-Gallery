...
export class Gallery {
    ...
    /** @type {number} */
    this.itemHeight = 250; // Estimated height of each image card
    /** @type {number} */
    this.buffer = 10; // Number of items to render above/below visible area
    /** @type {Array} */
    this.filteredImages = []; // Store filtered images for virtualization
    /** @type {number} */
    this.scrollPosition = 0; // Track scroll position
    /** @type {number} */
    this.viewportHeight = 0; // Height of the visible area
